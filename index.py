...
def calcular_estadisticas(valoracion, posicion):
    ...
    if posicion == "DEL":
        ataque = random.randint(round(valoracion * 0.9), valoracion + 6)
        ...
        tecnica_disparo = random.randint(round(valoracion * 0.93), valoracion + 6)
        tiros_libres = random.randint(round(valoracion * 0.85), valoracion + 3)
        ...
        precision_pie_malo = random.randint(3,8)
        frecuencia_pie_malo = random.randint(3,8)
    elif posicion == "EXT":
        ...
        cualidades_portero = 30
        trabajo_en_equipo = random.randint(round(valoracion * 0.85), valoracion + 3)
        estabilidad_soltura = random.randint(4,8)
        precision_pie_malo = random.randint(5,8)
        frecuencia_pie_malo = random.randint(3,8)
    elif posicion == "MP":
        ataque = random.randint(round(valoracion * 0.92), valoracion + 3)
        ...
        agilidad = random.randint(round(valoracion * 0.9), valoracion + 4)
        velocidad_maxima = random.randint(round(valoracion * 0.92), valoracion - 2)
        aceleracion = random.randint(round(valoracion * 0.9), valoracion - 3)
        respuesta = random.randint(round(valoracion * 0.9), valoracion - 1)
        precision_regate = random.randint(round(valoracion * 0.96), valoracion + 3)
        ...
        cualidades_portero = 30
        trabajo_en_equipo = random.randint(round(valoracion * 0.85), valoracion + 3)
        estabilidad_soltura = random.randint(3,8)
        precision_pie_malo = random.randint(2,8)
        frecuencia_pie_malo = random.randint(2,8)
    elif posicion == "MC":
        ataque = random.randint(round(valoracion * 0.88), valoracion + 4)
        defensa = random.randint(round(valoracion * 0.88), valoracion)
        ...
        tiros_libres = random.randint(round(valoracion * 0.8), valoracion - 5)
        efecto = random.randint(round(valoracion * 0.9), valoracion - 5)
        cabezazo = random.randint(round(valoracion * 0.78), round(valoracion * 0.87))        
        ...
        ataque = random.randint(round(valoracion * 0.7), valoracion - 7)
        defensa = random.randint(round(valoracion * 0.9), valoracion + 2)
        estabilidad = random.randint(round(valoracion * 0.89), valoracion - 3)
        resistencia = random.randint(round(valoracion * 0.93), valoracion + 5)
        agilidad = random.randint(round(valoracion * 0.9), valoracion - 4)
        velocidad_maxima = random.randint(round(valoracion * 0.84), valoracion - 8)
        aceleracion = random.randint(round(valoracion * 0.82), valoracion - 8)
        ...
        ataque = round(valoracion * 0.83)
        defensa = random.randint(round(valoracion * 0.85), valoracion - 1)
        estabilidad = random.randint(round(valoracion * 0.78), valoracion - 5)
        resistencia = random.randint(round(valoracion * 0.9), valoracion - 2)
        agilidad = random.randint(round(valoracion * 0.9), valoracion - 4)
        velocidad_maxima = random.randint(round(valoracion * 0.91), valoracion - 4)
        aceleracion = random.randint(round(valoracion * 0.88), valoracion - 3)
        respuesta = random.randint(round(valoracion * 0.8), valoracion - 4)
        precision_regate = random.randint(round(valoracion * 0.83), valoracion - 5)
        velocidad_regate = random.randint(round(valoracion * 0.83), valoracion - 5)
        precision_pase_corto = random.randint(round(valoracion * 0.9), valoracion - 2)
        velocidad_pase_corto = random.randint(round(valoracion * 0.9), valoracion - 2)
        precision_pase_largo = random.randint(round(valoracion * 0.9), valoracion - 4)
        velocidad_pase_largo = random.randint(round(valoracion * 0.9), valoracion - 4)
        precision_disparo = random.randint(round(valoracion * 0.6), valoracion - 10)
        potencia_disparo = random.randint(round(valoracion * 0.6), valoracion - 10)
        tecnica_disparo = random.randint(round(valoracion * 0.6), valoracion - 10)
        tiros_libres = random.randint(round(valoracion * 0.5), valoracion - 15)
        efecto = random.randint(round(valoracion * 0.9), valoracion - 3)
        cabezazo = random.randint(round(valoracion * 0.7), round(valoracion * 0.9))        
        salto = random.randint(round(valoracion * 0.7), round(valoracion * 0.9))    
        tecnica = random.randint(round(valoracion * 0.85), valoracion + 2)
        ...
        ataque = random.randint(round(valoracion * 0.5), round(valoracion * 0.7))
        defensa = random.randint(round(valoracion * 0.9), valoracion + 5)
        estabilidad = random.randint(round(valoracion * 0.6), valoracion - 15)
        resistencia = random.randint(round(valoracion * 0.78), valoracion - 6)
        agilidad = random.randint(round(valoracion * 0.9), valoracion - 4)
        velocidad_maxima = random.randint(round(valoracion * 0.6), valoracion - 4)
        aceleracion = random.randint(round(valoracion * 0.6), valoracion - 4)
        respuesta = random.randint(round(valoracion * 0.7), valoracion - 10)
        precision_regate = random.randint(round(valoracion * 0.83), valoracion - 5)
        velocidad_regate = random.randint(round(valoracion * 0.83), valoracion - 5)
        precision_pase_corto = random.randint(round(valoracion * 0.9), valoracion - 2)
        velocidad_pase_corto = random.randint(round(valoracion * 0.9), valoracion - 2)
